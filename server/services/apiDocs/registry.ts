...
import {
  ...
  financeDebtCreateSchema, financeDebtPaymentSchema,
...
export const routeRegistry: RouteDoc[] = [
  ...
  },
  {
    ...
    summary: 'Debts with payoff progress � the payoff-first view of loan and credit accounts.',
    tags: ['Finance'],
    auth: 'finance',
    responseDescription: 'One row per visible loan/credit account: amount owed, the original principal and progress for manual debts, and this month�s posted payments.',
  },
  {
    method: 'post',
    path: '/api/finance/debts',
    summary: 'Create a manual debt � an account whose opening balance is the negative principal.',
    tags: ['Finance'],
    auth: 'finance',
    requestSchema: financeDebtCreateSchema,
    responseDescription: 'The created account row.',
  },
  {
    method: 'post',
    path: '/api/finance/debts/{id}/payments',
    summary: 'Record a payment against a manual debt.',
    tags: ['Finance'],
    auth: 'finance',
    requestSchema: financeDebtPaymentSchema,
    pathParams: ['id'],
    responseDescription: 'The created transaction. A `400` for bank-synced debts � the payment arrives with the next sync.',
  },
  {
    method: 'post',
